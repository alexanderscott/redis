...
func (client *Client) Zrevrangebyscore(key string, end float64, start float64) ([][]byte, error) {
    res, err := client.sendCommand("ZREVRANGEBYSCORE", key, strconv.FormatFloat(end, 'f', -1, 64), strconv.FormatFloat(start, 'f', -1, 64))
    if err != nil {
        return nil, err
    }
